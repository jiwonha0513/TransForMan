	...
	<body>
		...
		<div id="insertStyling">
			<form name="insertStylingForm" method="post" enctype="multipart/form-data">
				...
				<div class="input"><input type="text" id="stylingName" name="stylingName" value="${stylingName }" autofocus /></div>
				<div class="span"><span id="notiStylingName"></span></div>
				<div class="input"><textarea id="stylingExplain" name="stylingExplain" maxlength="1000">${stylingExplain }</textarea></div>
				<div class="span"><span id="notiStylingExplain"></span></div>
				<div class="input"><input type="text" id="stylingTag" name="stylingTag" placeholder="해시태그 (선택 사항)" value="${hashTag }" /></div>
				...
				<div class="input"><input type="text" id="stylingVideo" name="stylingVideo" placeholder="유투브 URL (선택 사항)" value="${videoUrl }" /></div>
				<div class="span"><span id="notiStylingVideo">유투브 url을 입력해주세요. </span></div>
				<div class="input"><input type="text" id="productName" name="productName" placeholder="상품명 (선택 사항)" value="${product }" /></div>
				<div class="span"><span id="notiProductName">스타일링에 사용된 상품 이름을 입력해주세요. ,로 구분지어 입력해주세요.</span></div>
				
				<div class="button"><input type="button"  class="btn" onClick="updateStyling()" value="수정" /></div>
