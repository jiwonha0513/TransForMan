	...
	<body>
		...
		<div id="insertProduct">
			<form name="insertProductForm" method="post" enctype="multipart/form-data">
				...
				<div class="input"><input type="text" id="productName" name="productName" value="${productName }" autofocus /></div>
				<div class="span"><span id="notiProductName"></span></div>
				<div class="input"><input type="text" id="productPrice" name="productPrice" value="${productPrice }" /></div>
				<div class="span"><span id="notiProductPrice"></span></div>
				<div class="input"><input type="text" id="productCount" name="productCount" value="${productCount }" /></div>
				<div class="span"><span id="notiProductCount"></span></div>
				<div class="input"><textarea id="productExplain" name="productExplain" maxlength="1000">${productExplain }</textarea></div>
				...
				<div class="button"><input type="button"  class="btn" onClick="updateProduct()" value="수정" /></div>
